...
from torchdatasets.tabular.classification.from_csv import _prepare_classification_dataframe


class TabularClassificationFromExcel(BaseTabularClassificationDataset):
    def __init__(
        self,
        file_path: str | Path,
        *,
        ...
        if excel_path.suffix.lower() not in {".xls", ".xlsx"}:
            raise ValueError("TabularClassificationFromExcel expects an .xls or .xlsx file.")
